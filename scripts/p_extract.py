...
def check_if_harmonic(data: np.ndarray, column: int, line: int, threshold: float, depth: int = 3, inaccuracy: int = 3) -> bool:
...
def first_harmonics(audio_path: str, check_depth: int = 5, n_fft: int = 2048) -> np.ndarray:
    # load file
